...
Dependence: The following steps are to work in the Perl 5 or R environment. And samtools (http://www.htslib.org/) and STITCH (version v1.5.3.0008, http://www.stats.ox.ac.uk/~myers/) should be installed.
