...
The "bamlist" file records the path of your input bam files, and with only 1 column as "example/bamlist".
The "bamstats" file records the path of your input bam stats files which were generated by the command "samtools stats input.bam > input.bam.stats", and with only 1 column as "example/bamstats".
